...
function init() {
	...
	if (stickiesArray.length === 0) {
		var stickyObj = {
			"value": "Click me to delete",
			"color": "LightGoldenRodYellow"
		};
		localStorage.setItem("default-sticker", JSON.stringify(stickyObj));
		stickiesArray.push("default-sticker");
...
function createSticky() {
	...
	var colors = ["LightGoldenRodYellow", "PaleGreen", "LightPink", "LightBlue"];
